import { LoggerOptions, QueryRunner, Logger } from "typeorm";
...
export class FileLogger implements Logger {
    ...
    constructor(private options?: LoggerOptions, filePath = '') {
    ...
    protected write(strings: string|string[]) {
        ...
        writeFileSync(path.join(this.basePath, "ormlogs.log"), strings.join("\r\n") + "\r\n", {
            encoding: 'utf-8',
            flag: 'a'
        });
    }
